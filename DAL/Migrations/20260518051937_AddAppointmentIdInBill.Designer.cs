...
namespace DAL.Migrations
{
    ...
    [Migration("20260518051937_AddAppointmentIdInBill")]
    partial class AddAppointmentIdInBill
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Appoinment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.HospitalInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.Lab", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.MedicineReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.PatientReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.PrescribedMedicine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.TestPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.Timing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.Bill", b =>
                {
                    b.HasOne("DAL.Models.Appoinment", "Appoinment")
                        .WithMany()
                        .HasForeignKey("AppoinmentId");

                    b.HasOne("DAL.Models.Insurance", "Insurance")
                        .WithMany("Bill")
            ...
            modelBuilder.Entity("DAL.Models.Contact", b =>
                {
                    b.HasOne("DAL.Models.HospitalInfo", "Hospital")
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("DAL.Models.Payroll", b =>
                {
                    b.HasOne("DAL.Models.ApplicationUser", "EmployeeId")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.PrescribedMedicine", b =>
                {
                    ...
                    b.HasOne("DAL.Models.PatientReport", "PatientReport")
                        .WithMany("PrescribedMedicine")
