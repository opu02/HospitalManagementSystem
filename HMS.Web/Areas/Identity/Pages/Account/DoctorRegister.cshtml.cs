        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.PictureUri != null)
                {
                    ...
                    string fileName = Guid.NewGuid().ToString() + "_" + Input.PictureUri.FileName;
                    string serverFolder = Path.Combine(_env.WebRootPath, folder + fileName);
                    await Input.PictureUri.CopyToAsync(new FileStream(serverFolder, FileMode.Create));
                    user.PictureUri = "/" + folder + fileName;
                }
        ...
        private ApplicationUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(ApplicationUser)}'. " +
                    ...
                    $"override the register page in /Areas/Identity/Pages/Account/DoctorRegister.cshtml");
            }
        }
